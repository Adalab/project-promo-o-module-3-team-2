        ...
        <form action="" method="post" className="form">
          <fieldset className="fieldset__design">
            <div className="container__design js_designHeader">
              <i className="far fa-object-ungroup container__design--icon" alt="design"></i>
              <h3 className="container__design--title">diseña</h3>
              <i
                className="fas fa-chevron-up container__design--iconArrow js_arrowDesign"
              ></i>
            </div>
          ...
          <fieldset className="fieldset__fill">
            ...
            <div className="form_container js_collapsed js_fillContainer">
          ...
          <fieldset className="fieldset__share">
            <div className="container__share js_shareHeader">
              ...
              <i className="fas fa-chevron-up js_arrowShare container__share--iconArrow
                  arrowShare js_arrowRotate"></i>
            </div>
            <div className="js_collapsed js_shareContainer">
              <div className="container__button js_collapsed">
                <button className="container__button__btn--card js_create_button">
                  <i className="far fa-address-card container__button--icon"></i>crear tarjeta
                </button>
              </div>
            </div>
          </fieldset>
          ...
          <fieldset className="fieldset__share js_collapsed js_shareCollapse ">
            <div className="container__created">
              ...
              <a href="#" className="container__created--link js_cardURL js_twitterFetch " target="_blank"></a>
              <a type="submit" className="btn--twitter js_btnTwitter js_collapsed" target="_blank">
